...
2. Добавление информация об использовании пользователем дискового пространства. (сделано)
...
4. Создайте файл `.env` и заполните его переменными окружения (пример в файле `.env.example`).
5. Создайте прод и тест базу данных, юзера и дайте ему права. Внесите изменения в файл `.env`
```
CREATE DATABASE <db_name>;
CREATE DATABASE <test_db_name>; # для тестовой базы
